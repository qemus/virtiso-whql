...
The drivers are WHQL signed, unlike the [official ISO](https://fedorapeople.org/groups/virt/virtio-win/direct-downloads/latest-virtio/) and reduced from 600 MB to just 27 MB in size.
